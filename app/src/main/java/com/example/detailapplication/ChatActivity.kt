...
open class ChatActivity: AppCompatActivity() {
    ...
    inner class MessageViewHolder internal constructor(private val view: View) : RecyclerView.ViewHolder(view) {
     ...
     inner class MessageAdapter internal constructor(options: FirestoreRecyclerOptions<Message>) : com.firebase.ui.firestore.FirestoreRecyclerAdapter<Message, MessageViewHolder>(options) {
