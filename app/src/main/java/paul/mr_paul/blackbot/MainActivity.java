...
import paul.mr_paul.blackbot.Adapters.MessageAdapter;
import paul.mr_paul.blackbot.Contract.MessageContract;
import paul.mr_paul.blackbot.DBHelper.MessageDBHelper;
import paul.mr_paul.blackbot.DataTypes.MessageData;
import paul.mr_paul.blackbot.UtilityPackage.Constants;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Log.d("Bottom sheet behavior", "onCreate: " + e.toString());
        }
        ...
        {
            Log.d("Recyclerview", "onCreate: " + e.toString());
        }
        ...
        {
            Log.d("Message click listener", "onCreate: " + e.toString());
        }
        ...
        {
            Log.d("Delete chat messages", "onCreate: " + e.toString());
        }
